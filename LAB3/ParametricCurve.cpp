...
//
//void computeCircle() {
//    glBegin(GL_POLYGON); // Use GL_POLYGON to draw a filled circle
//    const float radius = 1.0; // Set the radius to a larger value
//    glBegin(GL_POLYGON); // Use GL_POLYGON to draw a filled circle
//    for (int i = 0; i < numPoints; i++) {
//        float t = 2 * 3.14159265 * i / numPoints;
//        glVertex2f(radius * cos(t), radius * sin(t)); // Use the new radius
//    }
//    glEnd();
//}
//
...
//    glColor3f(1.0, 1.0, 0.0); // Yellow (R=1, G=1, B=0)
//
